...
const sections = [
  ...
  },
  {
    ...
    icon: Settings,
    summary: "Tune alert rules, cooldowns, external delivery, and real security defaults.",
    bullets: [
      ...
      "Security settings control session timeout, default Safe Mode, and password policy for new/changed users.",
      "Safe Mode keeps looser security choices disabled in the UI; turn it off only when you intentionally want a relaxed default.",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    summary: "What is configurable, what is mandatory, and why.",
    bullets: [
      "Configurable: session timeout, default Safe Mode, minimum password length, and password complexity.",
      "Mandatory: authentication guard, CSRF checks, API rate limit, security headers, role boundaries, audit logging, and secret redaction.",
      "Session Timeout controls how long new login cookies remain valid: 1h/8h/24h are daily-use choices; 7d is only available when Safe Mode is off.",
      "Minimum Password Length applies to new users and password changes. Safe Mode keeps the floor at 12 characters; Safe Mode off allows 8-64.",
      "Password Complexity requires uppercase, lowercase, number, and symbol. It is locked on while Safe Mode is on.",
      "Default Safe Mode affects new browsers/users until they manually toggle Safe Mode in the sidebar.",
    ],
  },
  {
    id: "audit-users",
