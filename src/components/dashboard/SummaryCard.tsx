...
export function SummaryCard({
  ...
  return (
    <button
      ...
      className={clsx(
        "group relative flex items-start gap-4 rounded-xl bg-gray-800 border border-gray-700/60 p-4 text-left transition-all duration-200",
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {breakdown && (
          <p className="mt-1 text-xs text-gray-400">{breakdown}</p>
        )}
        {subtitle && (
